		...
		<div id="main">
			...
			<div id="border" align="center">
			  	<table width="750" border="1" align="center">
					...
					<?php
						$query = "SELECT scores.id, scores.name, scores.score, best_scores.score AS b_score, brackets.tiebreaker, brackets.63, brackets.email FROM scores, best_scores, brackets WHERE scores.scoring_type = best_scores.scoring_type and scores.scoring_type = 'main' and scores.id = best_scores.id AND scores.id = brackets.id ORDER BY best_scores.score DESC, scores.score DESC, scores.name ASC";
						...
						while($user = mysql_fetch_array($result)) {
							...
							echo $i;
							echo "&nbsp;&nbsp;</td><td>";
							echo "<a href=\"view.php?id=$user[id]\">" . stripslashes($user[name]) . 
"</a>";
							echo "</td><td>";
							echo $user['b_score'];
							echo "</td><td>";
