			...
			<form method="post" name="bracket" class="bracket" id="bracket" action="update.php?id=<?php echo $id?>">
				...
				<table width="700" border="1">
					...
					<tr>
						...
						<td rowspan="2">
							<select name="1" size="2" class="forms" id="1" onchange="update('1','33',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="33" size="2" class="forms" id="33" onchange="update('33','49',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="8">
							<select name="49" size="2" class="forms" id="49" onchange="update('49','57',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="16">
							<select name="57" size="2" class="forms" id="57" onchange="update('57','61',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="2" size="2" class="forms" id="2" onchange="update('2','33',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="3" size="2" class="forms" id="3" onchange="update('3','34',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="34" size="2" class="forms" id="34" onchange="update('34','49',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="4" size="2" class="forms" id="4" onchange="update('4','34',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="5" size="2" class="forms" id="5" onchange="update('5','35',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="35" size="2" class="forms" id="35" onchange="update('35','50',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="8">
							<select name="50" size="2" class="forms" id="50" onchange="update('50','57',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="6" size="2" class="forms" id="6" onchange="update('6','35',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="7" size="2" class="forms" id="7" onchange="update('7','36',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="36" size="2" class="forms" id="36" onchange="update('36','50',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="8" size="2" class="forms" id="8" onchange="update('8','36',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
				...
				<table width="700" border="1">
					...
					<tr>
						...
						<td rowspan="2">
							<select name="9" class="forms" size="2" id="9" onchange="update('9','37',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="37" class="forms" size="2" id="37" onchange="update('37','51',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="8">
							<select name="51" class="forms" size="2" id="51" onchange="update('51','58',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="16">
							<select name="58" class="forms" size="2" id="58" onchange="update('58','61',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="10" class="forms" size="2" id="10" onchange="update('10','37',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="11" class="forms" size="2" id="11" onchange="update('11','38',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="38" class="forms" size="2" id="38" onchange="update('38','51',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="12" class="forms" size="2" id="12" onchange="update('12','38',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="13" class="forms"  size="2"id="13" onchange="update('13','39',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="39" class="forms"  size="2"id="39" onchange="update('39','52',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="8">
							<select name="52" class="forms"  size="2" id="52" onchange="update('52','58',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="14" size="2" class="forms" id="14" onchange="update('14','39',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="15" class="forms" size="2" id="15" onchange="update('15','40',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="40" class="forms" size="2" id="40" onchange="update('40','52',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="16" class="forms" size="2" id="16" onchange="update('16','40',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
				...
				<table width="700" border="1">
					...
					<tr>
						...
						<td rowspan="2">
							<select name="17" class="forms" size="2" id="17" onchange="update('17','41',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="41" class="forms" size="2" id="41" onchange="update('41','53',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="8">
							<select name="53" class="forms" size="2" id="53" onchange="update('53','59',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="16">
							<select name="59" class="forms" size="2" id="59" onchange="update('59','62',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="18" size="2" class="forms" id="18" onchange="update('18','41',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="19" size="2" class="forms" id="19" onchange="update('19','42',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="42" size="2" class="forms" id="42" onchange="update('42','53',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="20" size="2" class="forms" id="20" onchange="update('20','42',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="21" size="2" class="forms" id="21" onchange="update('21','43',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="43" class="forms" size="2" id="43" onchange="update('43','54',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="8">
							<select name="54" class="forms" size="2" id="54" onchange="update('54','59',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="22" class="forms" size="2" id="22" onchange="update('22','43',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="23" class="forms" size="2" id="23" onchange="update('23','44',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="44" class="forms" size="2" id="44" onchange="update('44','54',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="24" class="forms" size="2" id="24" onchange="update('24','44',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
				...
				<table width="700" border="1">
					...
					<tr>
						...
						<td rowspan="2">
							<select name="25" class="forms" size="2" id="25" onchange="update('25','45',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="45" class="forms" size="2" id="45" onchange="update('45','55',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="8">
							<select name="55" class="forms" size="2" id="55" onchange="update('55','60',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="16">
							<select name="60" class="forms" size="2" id="60" onchange="update('60','62',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="26" class="forms" size="2" id="26" onchange="update('26','45',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="27" class="forms" size="2" id="27" onchange="update('27','46',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="46" class="forms" size="2" id="46" onchange="update('46','55',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="28" class="forms" size="2" id="28" onchange="update('28','46',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="29" class="forms" size="2" id="29" onchange="update('29','47',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="47" class="forms" size="2" id="47" onchange="update('47','56',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="8">
							<select name="56" class="forms" size="2" id="56" onchange="update('56','60',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="30" class="forms" size="2" id="30" onchange="update('30','47',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="31" class="forms" size="2" id="31" onchange="update('31','48',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
						...
						<td rowspan="4">
							<select name="48" class="forms" size="2" id="48" onchange="update('48','56',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="32" class="forms" size="2" id="32" onchange="update('32','48',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
				...
				<table width="700" border="1">
					...
					<tr>
						...
						<td rowspan="2">
							<select name="61" size="2" class="forms" id="61" onchange="update('61','63',0);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
					...
					<tr>
						...
						<td rowspan="2">
							<select name="62" size="2" class="forms" id="62" onchange="update('62','63',1);">
								<?php if( $iphone ) { ?><option value=""></option><?php } ?>								
