 ...
 * 2. allow user to change display name
 * 2. choose favorite hunger-related charity (pick list or write in - we'll validate)
 * 3. allow user to choose their state (explain why)
 * 4. Display donation status
 * 5. Offer link to donate if not yet donated
 * 6. Copy explaining next steps and dates when bracket will be ready
 *
 */
?>
