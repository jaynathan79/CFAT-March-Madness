...
//replace with function to check for configured
...
{
	//$_SESSION['errors'] = "You have already submitted a bracket.";
	//header('Location:index.php');
	//exit();
	echo("You have already submitted a bracket.");
	include("cfatfooter.php");
	exit();
}

$meta = getMeta();
$teams = getMasterBracketTeams();
$teamNames = getMasterBracketTeamNames();
$seeds = getMasterBracketSeeds();
if(count($teams) < 1 || count($teamNames) < 1 || count($seeds) < 1) {//if fetching the array fails, prompt configuration
...
?>
	...
	function validateFields( alertText )
	{
		...
		var moreFields = new Array('tiebreaker');
...
If you want a hard copy of your bracket before the tournament begins, please PRINT your bracket before submitting it.</p>
				<table class="bracketentry">
					<tr>
						<td colspan="4" class="region"><h1><?php echo $meta['region1']?></h1></td>
					</tr>
					
					<tr>
						<td>
							<select name="game1" size="2" class="forms" id="game1" onchange="update('game1','game33',0);">
								<option value="<?php echo $teams[1]?>"><?php echo $teamNames['1']?></option>
								<option value="<?php echo $teams[2]?>"><?php echo $teamNames['2']?></option>
							</select>
						</td>
						<td rowspan="2">
							<select name="game33" size="2" class="forms" id="game33" onchange="update('game33','game49',0);"></select>
						</td>
						<td rowspan="4">
							<select name="game49" size="2" class="forms" id="game49" onchange="update('game49','game57',0);"></select>
						</td>
						<td rowspan="8">
							<select name="game57" size="2" class="forms" id="game57" onchange="update('game57','game61',0);"></select>
						</td>
					</tr>
					
					<tr>
						<td>
							<select name="game2" size="2" class="forms" id="game2" onchange="update('game2','game33',1);">
					...
					<tr>
						<td><select name="game3" size="2" class="forms" id="game3" onchange="update('game3','game34',0);">
								<option value="<?php echo $teams[5]?>" ><?php echo $teamNames['5']?></option>
								<option value="<?php echo $teams[6]?>" ><?php echo $teamNames['6']?></option>
							</select></td>
						<td rowspan="2"><select name="game34" size="2" class="forms" id="game34" onchange="update('game34','game49',1);">
							</select></td>
					</tr>
					
					<tr>
						<td><select name="game4" size="2" class="forms" id="game4" onchange="update('game4','game34',1);">
					...
					<tr>
						<td><select name="game5" size="2" class="forms" id="game5" onchange="update('game5','game35',0);">
								<option value="<?php echo $teams[9]?>" ><?php echo $teamNames['9']?></option>
								<option value="<?php echo $teams[10]?>" ><?php echo $teamNames['10']?></option>
							</select></td>
						<td rowspan="2"><select name="game35" size="2" class="forms" id="game35" onchange="update('game35','game50',0);">
							</select></td>
						<td rowspan="4"><select name="game50" size="2" class="forms" id="game50" onchange="update('game50','game57',1);">
							</select></td>
					</tr>
					
					<tr>
						<td><select name="game6" size="2" class="forms" id="game6" onchange="update('game6','game35',1);">
					...
					<tr>
						<td><select name="game7" size="2" class="forms" id="game7" onchange="update('game7','game36',0);">
								<option value="<?php echo $teams[13]?>" ><?php echo $teamNames['13']?></option>
								<option value="<?php echo $teams[14]?>" ><?php echo $teamNames['14']?></option>
							</select></td>
						<td rowspan="2"><select name="game36" size="2" class="forms" id="game36" onchange="update('game36','game50',1);">
							</select></td>
					</tr>
					
					<tr>
						<td><select name="game8" size="2" class="forms" id="game8" onchange="update('game8','game36',1);">
				...
				<table class="bracketentry">
					<tr>
						<td colspan="4"><h1><?php echo $meta['region2']?></h1></td>
					</tr>
					<tr>
						<td><select name="game9" class="forms" size="2" id="game9" onchange="update('game9','game37',0);">
								<option value="<?php echo $teams[17]?>" ><?php echo $teamNames['17']?></option>
								<option value="<?php echo $teams[18]?>" ><?php echo $teamNames['18']?></option>
							</select></td>
						<td rowspan="2"><select name="game37" class="forms" size="2" id="game37" onchange="update('game37','game51',0);">
						</select></td>
						<td rowspan="4"><select name="game51" class="forms" size="2" id="game51" onchange="update('game51','game58',0);">
						</select></td>
						<td rowspan="8"><select name="game58" class="forms" size="2" id="game58" onchange="update('game58','game61',1);">
						</select></td>
					</tr>
					<tr>
						<td><select name="game10" class="forms" size="2" id="game10" onchange="update('game10','game37',1);">
								<option value="<?php echo $teams[19]?>" ><?php echo $teamNames['19']?></option>
								<option value="<?php echo $teams[20]?>" ><?php echo $teamNames['20']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game11" class="forms" size="2" id="game11" onchange="update('game11','game38',0);">
							<option value="<?php echo $teams[21]?>" ><?php echo $teamNames['21']?></option>
							<option value="<?php echo $teams[22]?>" ><?php echo $teamNames['22']?></option>
							</select></td>
						<td rowspan="2"><select name="game38" class="forms" size="2" id="game38" onchange="update('game38','game51',1);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game12" class="forms" size="2" id="game12" onchange="update('game12','game38',1);">
							<option value="<?php echo $teams[23]?>" ><?php echo $teamNames['23']?></option>
							<option value="<?php echo $teams[24]?>" ><?php echo $teamNames['24']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game13" class="forms"  size="2"id="game13" onchange="update('game13','game39',0);">
								<option value="<?php echo $teams[25]?>" ><?php echo $teamNames['25']?></option>
								<option value="<?php echo $teams[26]?>" ><?php echo $teamNames['26']?></option>
							</select></td>
						<td rowspan="2"><select name="game39" class="forms"  size="2"id="game39" onchange="update('game39','game52',0);">
							</select></td>
						<td rowspan="4"><select name="game52" class="forms"  size="2" id="game52" onchange="update('game52','game58',1);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game14" size="2" class="forms" id="game14" onchange="update('game14','game39',1);">
								<option value="<?php echo $teams[27]?>" ><?php echo $teamNames['27']?></option>
								<option value="<?php echo $teams[28]?>" ><?php echo $teamNames['28']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game15" class="forms" size="2" id="game15" onchange="update('game15','game40',0);">
								<option value="<?php echo $teams[29]?>" ><?php echo $teamNames['29']?></option>
								<option value="<?php echo $teams[30]?>" ><?php echo $teamNames['30']?></option>
							</select></td>
						<td rowspan="2"><select name="game40" class="forms" size="2" id="game40" onchange="update('game40','game52',1);">
							</select></td>
					</tr>
					<tr>
						<td>
							<select name="game16" class="forms" size="2" id="game16" onchange="update('game16','game40',1);">
				...
				<table class="bracketentry">
					<tr>
						<td colspan="4"><h1><?php echo $meta['region3']?></h1></td>
					</tr>
					<tr>
						<td><select name="game17" class="forms" size="2" id="game17" onchange="update('game17','game41',0);">
								<option value="<?php echo $teams[33]?>" ><?php echo $teamNames['33']?></option>
								<option value="<?php echo $teams[34]?>" ><?php echo $teamNames['34']?></option>
							</select></td>
						<td rowspan="2"><select name="game41" class="forms" size="2" id="game41" onchange="update('game41','game53',0);">
							</select></td>
						<td rowspan="4"><select name="game53" class="forms" size="2" id="game53" onchange="update('game53','game59',0);">
							</select></td>
						<td rowspan="8"><select name="game59" class="forms" size="2" id="game59" onchange="update('game59','game62',0);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game18" size="2" class="forms" id="game18" onchange="update('game18','game41',1);">
								<option value="<?php echo $teams[35]?>" ><?php echo $teamNames['35']?></option>
								<option value="<?php echo $teams[36]?>" ><?php echo $teamNames['36']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game19" size="2" class="forms" id="game19" onchange="update('game19','game42',0);">
							<option value="<?php echo $teams[37]?>" ><?php echo $teamNames['37']?></option>
							<option value="<?php echo $teams[38]?>" ><?php echo $teamNames['38']?></option>
												</select></td>
						<td rowspan="2"><select name="game42" size="2" class="forms" id="game42" onchange="update('game42','game53',1);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game20" size="2" class="forms" id="game20" onchange="update('game20','game42',1);">
								<option value="<?php echo $teams[39]?>" ><?php echo $teamNames['39']?></option>
								<option value="<?php echo $teams[40]?>" ><?php echo $teamNames['40']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game21" size="2" class="forms" id="game21" onchange="update('game21','game43',0);">
							<option value="<?php echo $teams[41]?>" ><?php echo $teamNames['41']?></option>
							<option value="<?php echo $teams[42]?>" ><?php echo $teamNames['42']?></option>
							</select></td>
						<td rowspan="2"><select name="game43" class="forms" size="2" id="game43" onchange="update('game43','game54',0);">
							</select></td>
						<td rowspan="4"><select name="game54" class="forms" size="2" id="game54" onchange="update('game54','game59',1);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game22" class="forms" size="2" id="game22" onchange="update('game22','game43',1);">
							<option value="<?php echo $teams[43]?>" ><?php echo $teamNames['43']?></option>
							<option value="<?php echo $teams[44]?>" ><?php echo $teamNames['44']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game23" class="forms" size="2" id="game23" onchange="update('game23','game44',0);">
							<option value="<?php echo $teams[45]?>" ><?php echo $teamNames['45']?></option>
							<option value="<?php echo $teams[46]?>" ><?php echo $teamNames['46']?></option>
							</select></td>
						<td rowspan="2"><select name="game44" class="forms" size="2" id="game44" onchange="update('game44','game54',1);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game24" class="forms" size="2" id="game24" onchange="update('game24','game44',1);">
				...
				<table class="bracketentry">
					<tr>
						<td colspan="4"><h1><?php echo $meta['region4']?></h1></td>
					</tr>
					<tr>
						<td><select name="game25" class="forms" size="2" id="game25" onchange="update('game25','game45',0);">
							<option value="<?php echo $teams[49]?>" ><?php echo $teamNames['49']?></option>
							<option value="<?php echo $teams[50]?>" ><?php echo $teamNames['50']?></option>
						</select></td>
						<td rowspan="2"><select name="game45" class="forms" size="2" id="game45" onchange="update('game45','game55',0);">
						</select></td>
						<td rowspan="4"><select name="game55" class="forms" size="2" id="game55" onchange="update('game55','game60',0);">
						</select></td>
						<td rowspan="8"><select name="game60" class="forms" size="2" id="game60" onchange="update('game60','game62',1);">
						</select></td>
					</tr>
					<tr>
						<td><select name="game26" class="forms" size="2" id="game26" onchange="update('game26','game45',1);">
								<option value="<?php echo $teams[51]?>" ><?php echo $teamNames['51']?></option>
								<option value="<?php echo $teams[52]?>" ><?php echo $teamNames['52']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game27" class="forms" size="2" id="game27" onchange="update('game27','game46',0);">
							<option value="<?php echo $teams[53]?>" ><?php echo $teamNames['53']?></option>
							<option value="<?php echo $teams[54]?>" ><?php echo $teamNames['54']?></option>
							</select></td>
						<td rowspan="2"><select name="game46" class="forms" size="2" id="game46" onchange="update('game46','game55',1);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game28" class="forms" size="2" id="game28" onchange="update('game28','game46',1);">
								<option value="<?php echo $teams[55]?>" ><?php echo $teamNames['55']?></option>
								<option value="<?php echo $teams[56]?>" ><?php echo $teamNames['56']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game29" class="forms" size="2" id="game29" onchange="update('game29','game47',0);">
								<option value="<?php echo $teams[57]?>" ><?php echo $teamNames['57']?></option>
								<option value="<?php echo $teams[58]?>" ><?php echo $teamNames['58']?></option>
							</select></td>
						<td rowspan="2"><select name="game47" class="forms" size="2" id="game47" onchange="update('game47','game56',0);">
							</select></td>
						<td rowspan="4"><select name="game56" class="forms" size="2" id="game56" onchange="update('game56','game60',1);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game30" class="forms" size="2" id="game30" onchange="update('game30','game47',1);">
								<option value="<?php echo $teams[59]?>" ><?php echo $teamNames['59']?></option>
								<option value="<?php echo $teams[60]?>" ><?php echo $teamNames['60']?></option>
							</select></td>
					</tr>
					<tr>
						<td><select name="game31" class="forms" size="2" id="game31" onchange="update('game31','game48',0);">
								<option value="<?php echo $teams[61]?>" ><?php echo $teamNames['61']?></option>
								<option value="<?php echo $teams[62]?>" ><?php echo $teamNames['62']?></option>
							</select></td>
						<td rowspan="2"><select name="game48" class="forms" size="2" id="game48" onchange="update('game48','game56',1);">
							</select></td>
					</tr>
					<tr>
						<td><select name="game32" class="forms" size="2" id="game32" onchange="update('game32','game48',1);">
				...
				<table  class="bracketentry"><tr><td>
